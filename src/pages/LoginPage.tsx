...
export default function LoginPage() {
    ...
    const doLogin = async (fn: () => Promise<AuthResponse>) => {
        if (loading) return;
    ...
    const onEmailLogin = async (e: React.FormEvent) => {
        e.preventDefault();
        await doLogin(() => apiPost<AuthResponse>('/auth/login', {email: email.trim(), password}));
    };
                ...
                <div className="p-8">
                    ...
                    <div className="mt-6 items-center">
                        <div className={loading ? 'pointer-events-none opacity-60' : ''}>
                            <GoogleLogin
                                onSuccess={(cred) =>
                                    doLogin(() => apiPost<AuthResponse>('/auth/google', {credential: cred.credential}))
                                }
